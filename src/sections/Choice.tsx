  ...
  return (
    <section id="choice" className="px-4 py-4"> 
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <button 
          onClick={() => window.open("https://docs.google.com/forms/d/e/1FAIpQLSfq15fR6o6vdk7YUaz--S8hE3TKcRMACTSGlzYy3cIIRu77ZQ/viewform?usp=header", "_blank")}   
        ...
        <button 
          onClick={() => window.open("https://docs.google.com/forms/d/e/1FAIpQLSd1cr0melTl6gWPX-fqtlaEFIRcjgfICHhNUPMnlLWKdQCk5w/viewform?usp=header", "_blank")}  
          className="relative rounded-2xl flex items-center justify-center text-3xl sm:text-5xl text-white bg-cover bg-center transition duration-300 hover:brightness-50 active:brightness-75 p-4 w-[92.5%] sm:w-[48%] aspect-square sm:aspect-[2/1]"
