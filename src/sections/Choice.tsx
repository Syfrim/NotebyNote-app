...
function Choice() {
  return (
    <section id="choice" className="px-4 py-4"> {/* 16px padding from screen edges & next sections */}
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4"> {/* 16px gap between buttons */}
