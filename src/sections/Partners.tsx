...
function Partners() {
  return(
    <section id="partners" className="mt-20 flex flex-col bg-gray-50 py-20">
        ...
        <LogoWall src1={Bedc} src2={Mastercard} src3={Mtn} alt1="Bedc logo" alt2="Mastercard logo" alt3="Mtn logo"/>
        
        </div>
        <div className="xl:flex xl:justify-center">
        <LogoWall src1={Airtel} src2={Payoneer} src3={Visa} alt1="Airtel logo" alt2="Payoneer logo" alt3="Visa logo"/>
        <LogoWall src1={Mobile} src2={Ikeja} src3={Dstv} alt1="Mobile logo" alt2="Ikeja logo" alt3="Dstv logo"/>
