      ...
      {({ open }) => (
        <>
          <div className="flex h-[15vh] max-w-7xl items-center justify-between px-8 xlm:-auto lg:px-12">   
            ...
            <ButtonLink href="https://play.google.com" target="_blank" children={"Install Kobodrop"} className='active: bg hidden bg-gray-800 text-white rounded-xl px-5 py-3 hover:bg-gray-900 active:bg-gray-600 sm:flex'></ButtonLink>
